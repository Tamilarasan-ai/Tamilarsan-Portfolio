    ...
    >
      ...
      <div className="w-full flex justify-between items-center max-w-7x1 mx-auto">
        ...
        >
           ...
           <li className=" hover:text-white text-[18px] font-medium cursor-pointer"><a href='https://drive.google.com/drive/folders/1sZvPmFIqmUHSV-_XGcJV-ZXhtEgm8vQb?usp=drive_link'target="_blank" download="Resume.pdf">Resume</a></li>
          {navLinks.map((link) => {
            return (
        ...
        <div className="sm:hidden flex flex-1 justify-end items-center">
          ...
          >
            ...
            <ul className="list-none flex justify-end items-start flex-col gap-4 text-grayscale-50">
              ...
              <li><a href='https://drive.google.com/drive/folders/1sZvPmFIqmUHSV-_XGcJV-ZXhtEgm8vQb?usp=drive_link'target="_blank" download="Resume.pdf">Resume</a></li>
            </ul>
            <ul>
