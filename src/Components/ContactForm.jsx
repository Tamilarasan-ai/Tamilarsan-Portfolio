...
const ContactForm = () => {
	...
	const sendEmail = (e) => {
		...
		emailjs
			.sendForm("service_kli8s2n", "template_9aez2qp", e.target, "Vrq45MC3_UMSVzZRK")
			.then(
				(result) => {
		...
		>
			<div>
				<h2
					...
					className="message text-7xl bg-primary-600 p-2 rounded-xl text-grayscale-950 text-center rounded-br-[0%] relative shadow-2xl"
				>
			...
			<div className="w-full flex justify-center">
				...
				>
					...
					<div className="w-full flex justify-center">
						<input
							className="w-[100px] h-[50px] bg-primary-600 text-grayscale-950 rounded-xl cursor-pointer hover:bg-primary-700"
							type="submit"
